...
const config: SiteConfig = {
  ...
  website: {
    title: "یادگیری با مهدی", // Homepage title
    titleShort: "یادگیری با مهدی", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation
    name: "یادگیری با مهدی", // Website name used for homescreen (PWA) and SEO
    description: "وبسایت کمکی برای کانالو یوتوب یادگیری با مهدی", // Website description used for RSS feeds/meta description tag
    language: "en", // Sets the global HTML lang attribute
    logoUrl: "/logos/logo-1024.png", // Logo used for SEO
    url: "https://example.com", // Domain of your website without the pathPrefix
    rss: "/rss.xml", // Path to the RSS file
    rssTitle: "یادگیری با مهدی RSS Feed", // Title of the RSS feed
    copyright: "© کپی‌رایت ۱۴۰۰", // Copyright string for the footer of the website and RSS feed.
